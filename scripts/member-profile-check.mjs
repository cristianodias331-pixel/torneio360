...
assert(platformV2ProfileSource.includes("Deseja realmente apagar esta foto") && platformV2ProfileSource.includes("window.confirm"), "A exclusão de fotos da galeria deve exigir confirmação explícita.");
