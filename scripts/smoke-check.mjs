...
assert.ok(
  mainSource.includes("readStoryCoverFile")
    ...
    && styleSource.includes("PALETA SEMÂNTICA SUAVE DOS BOTÕES — HOMOLOGAÇÃO")
    && styleSource.includes("--button-green-bg: #dceee4")
    && mainSource.includes('className="actionConfirmBtn eventGroupSaveButton"')
