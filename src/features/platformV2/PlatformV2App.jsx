      ...
      <div className={styles.createTournamentBody}>
        {currentStep === 1 ? (
          <section className={styles.createTournamentPanel} aria-labelledby="create-step-information">
            <header><span><FileText /></span><div><h2 id="create-step-information">Informações principais</h2></div></header>
          ...
          <section className={styles.createTournamentPanel} aria-labelledby="create-step-agenda">
            ...
            {draft.structure === "single" ? (
              <div className={styles.createTournamentFields}>
                ...
                <label><span>Horário de início do evento</span><input type="time" value={draft.startTime} onChange={(event) => updateDraft("startTime", event.target.value)} /></label>
                ...
                {draft.groupedCategories.map((category, index) => (
                  <article className={styles.createTournamentGroupedCard} key={`schedule-${index}`}>
                    ...
                    <div className={`${styles.createTournamentFields} ${styles.createTournamentScheduleFields}`}>
                      ...
                      <label><span>Horário de início do evento</span><input type="time" value={category.startTime} onChange={(event) => updateGroupedCategory(index, "startTime", event.target.value)} /></label>
        ...
        {currentStep === 5 ? (
          <section className={styles.createTournamentPanel} aria-labelledby="create-step-review">
            <header><span><Check /></span><div><h2 id="create-step-review">Revisar e salvar</h2></div></header>
