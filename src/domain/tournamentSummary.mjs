export const tournamentSummarySelect = [
  ...
  "summary_cover_image_thumbnail_url:data->>coverImageThumbnailUrl",
  "summary_event_cover_image_thumbnail_url:data->>eventCoverImageThumbnailUrl",
...
export function normalizeTournamentSummaryRow(row = {}) {
  const data = definedEntries([
    ...
    ["coverImageThumbnailUrl", row.summary_cover_image_thumbnail_url],
    ["eventCoverImageThumbnailUrl", row.summary_event_cover_image_thumbnail_url],
