...
-- A listagem pública aceita organizadores confirmados que ainda conservam o
-- papel legado organizer_pending. O carregamento do perfil precisa seguir a
-- mesma regra para que uma arena nunca apareça no diretório sem poder abrir.
-- Esta função apenas lê dados públicos; nenhuma conta ou informação salva é
